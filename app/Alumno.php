...
class Alumno extends Authenticatable
{
    ...
    protected $filliable= ['rut','nombre','apellido_paterno','apellido_materno','nivel','ingreso','password','asignaturas_aprobadas','targeta_credito','fecha_caducidad','cvc','nas','ppa','nar','fecha_nacimiento','nacionalidad','estado_civil','sexo','telefono','region','provincia','comuna','correo'];
