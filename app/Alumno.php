...
class Alumno extends Model
{
    ...
    protected $filliable= ['nombre','apellido_paterno','apellido_materno','nivel','ingreso','password','asignaturas_aprovadas','nas','ppa','nar','fecha_nacimiento','nacionalidad','estado_civil','sexo','telefono','region','provincia','comuna','correo'];
